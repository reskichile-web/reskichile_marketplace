...
describe('Vercel cron configuration', () => {
  it('preserves sale reminders and adds the seventeen daily Hobby-safe Instagram ticks', () => {
    ...
    expect(config.crons.filter((entry: { path: string }) => entry.path.startsWith('/api/cron/instagram-publish/')))
      .toEqual([
        ...
        { path: '/api/cron/instagram-publish/t2045', schedule: '45 20 * * *' },
        { path: '/api/cron/instagram-publish/t2100', schedule: '0 21 * * *' },
        { path: '/api/cron/instagram-publish/t2115', schedule: '15 21 * * *' },
        { path: '/api/cron/instagram-publish/t2130', schedule: '30 21 * * *' },
        { path: '/api/cron/instagram-publish/t2145', schedule: '45 21 * * *' },
        { path: '/api/cron/instagram-publish/t2200', schedule: '0 22 * * *' },
        { path: '/api/cron/instagram-publish/t2215', schedule: '15 22 * * *' },
        { path: '/api/cron/instagram-publish/t2230', schedule: '30 22 * * *' },
        { path: '/api/cron/instagram-publish/t2245', schedule: '45 22 * * *' },
        { path: '/api/cron/instagram-publish/t2300', schedule: '0 23 * * *' },
        { path: '/api/cron/instagram-publish/t2315', schedule: '15 23 * * *' },
        { path: '/api/cron/instagram-publish/t2330', schedule: '30 23 * * *' },
        { path: '/api/cron/instagram-publish/t2345', schedule: '45 23 * * *' },
        { path: '/api/cron/instagram-publish/t0000', schedule: '0 0 * * *' },
        { path: '/api/cron/instagram-publish/t0015', schedule: '15 0 * * *' },

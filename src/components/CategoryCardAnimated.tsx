...
// framer-motion lives here → its own chunk, loaded only on fast connections.
...
export default function CategoryCardAnimated({ type, label, image, imagePosition, darkOverlay }: CategoryCardProps) {

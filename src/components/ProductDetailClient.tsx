          ...
          {!isOwner && product.seller_id && (
            <div className="mt-6 flex gap-2 w-full">
              <button
                ...
                disabled={contacting}
                className="pressable flex-1 inline-flex items-center justify-center gap-2 bg-green-600 text-white px-4 py-3 hover:bg-green-700 disabled:opacity-50 font-medium"
              >
              ...
              <button
                ...
                className="pressable flex-1 inline-flex items-center justify-center gap-2 bg-brand-400 text-white px-4 py-3 hover:bg-brand-500 disabled:opacity-50 font-medium"
              >
                <svg className="w-5 h-5 shrink-0 fill-current" viewBox="0 0 130 150" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">

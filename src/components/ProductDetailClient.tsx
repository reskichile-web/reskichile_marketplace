          ...
          {!isOwner && product.seller_id && (
            <div className="mt-6 flex justify-center gap-2 flex-wrap">
              <button
                ...
                disabled={contacting}
                className="pressable inline-flex items-center gap-2 bg-green-600 text-white px-5 py-3 rounded-lg hover:bg-green-700 disabled:opacity-50 font-medium"
              >
              ...
              <button
                ...
                aria-label="Chat por Reski"
                className="pressable inline-flex items-center gap-2 bg-brand-400 text-white px-5 py-3 rounded-lg hover:bg-brand-500 disabled:opacity-50 font-medium"
              >

...
// The animated drawer (framer-motion) lives here so it loads in its own chunk
// only after the user first opens the mobile menu — keeping framer-motion out of
// every page's initial bundle (MobileMenu, which renders it, is in the header).

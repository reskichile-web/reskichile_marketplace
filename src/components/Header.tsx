      ...
      <div>
        <div className="max-w-7xl mx-auto px-4 md:px-8 h-[60px] md:h-[72px] flex items-center gap-3 md:gap-12">
          ...
          <div className="hidden md:flex items-center gap-3 shrink-0">
            ...
            <Link href="/vender" className="pressable inline-flex h-9 items-center justify-center bg-brand-500 px-5 text-sm text-white transition-colors hover:bg-brand-600 font-nav">
              Vender
            </Link>
            {showSkiRackCart && <SkiRackCartLink />}
            {userId && (
              <>
                <Link
                  href="/mis-productos"
                  className="pressable inline-flex h-9 items-center gap-2 rounded-sm border border-gray-200 bg-white px-4 text-sm text-gray-700 transition-colors hover:border-brand-300 hover:text-brand-500 font-nav"
                >

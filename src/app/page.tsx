    ...
    <div>
      ...
      <section className="relative overflow-hidden -mt-[96px] md:-mt-[131px]">
        ...
        <div className="flex flex-row justify-center md:justify-start gap-3 sm:gap-4 mt-8 md:mt-10">
          ...
          <Link
            href="/vender"
            className="pressable inline-flex items-center justify-center gap-1.5 md:gap-2.5 border border-gray-300/70 bg-white/80 px-4 md:px-8 py-2.5 md:py-3.5 rounded-full font-medium hover:bg-white hover:border-gray-400 hover:-translate-y-0.5 transition-all duration-200 text-xs md:text-base"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">

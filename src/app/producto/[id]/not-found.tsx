  ...
  return (
    <div className="max-w-md mx-auto mt-16 px-4 text-center">
      ...
      <div className="flex gap-3 justify-center">
        <Link href="/catalogo" className="pressable bg-brand-500 text-white px-6 py-2.5 rounded-lg text-sm font-medium hover:bg-brand-600 transition-colors">
          Ver catalogo
        </Link>
        <Link href="/" className="pressable border border-gray-200 px-6 py-2.5 rounded-lg text-sm font-medium hover:bg-gray-50 transition-colors">
          Inicio
        </Link>
      </div>
    </div>
